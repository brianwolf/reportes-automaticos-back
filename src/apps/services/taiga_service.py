...
_API_TAREAS = var.get('API_TAREAS')
...
def descargar_csv_tareas() -> bytes:
    '''
    Descarga el reporte de csv
    '''
    url_completa = _TAIGA_HOST + _API_TAREAS
...
def descargar_csv_tareas_diccionario() -> dict:
    '''
    Descaga el csv en formato de disccionario
    '''
    contenido = descargar_csv_tareas()
    return csv_a_diccionario(contenido)


def generar_reporte_json(filtros: Filtros) -> dict:
    '''
    ...
    '''
    tareas = descargar_csv_tareas_diccionario()
